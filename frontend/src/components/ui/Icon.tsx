// Set de íconos inline (SVG, estilo feather/lucide) — sin dependencia externa.
// Uso: <Icon name="users" /> · hereda el color por `currentColor` y el tamaño por `size`.
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  // Cruz simple, para cerrar avisos y paneles (no confundir con "x-circle", que es de estado).
  close: (
    <>
