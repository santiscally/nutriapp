 ...
 *   <li>{@code resource_access.nutriapp-backend.roles} → sin prefijo
...
public class SecurityConfig {
    ...
    private static final String BACKEND_CLIENT_ID = "nutriapp-backend";
    ...
    public Converter<Jwt, AbstractAuthenticationToken> keycloakJwtAuthenticationConverter() {
        ...
        converter.setJwtGrantedAuthoritiesConverter(jwt -> {
            ...
            // Client roles del nutriapp-backend → authority plano (e.g. recetas:write)
