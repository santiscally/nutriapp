...
/**
 * Las columnas del maestro de artículos de TBC que nutriapp lee. Son 9 de las 126 que tiene la
 ...
 * deliberadamente: no entra a la base de nutriapp (ver 07-maestro-articulos-y-catalogo.md §0).
 */
