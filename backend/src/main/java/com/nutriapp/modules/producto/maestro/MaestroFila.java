...
/**
 * Una fila del maestro, ya limpia: solo los 10 campos que nutriapp lee, sin nada de la estructura de
 * costos de TBC.
 *
 ...
 * @param bloqueado      ESTADO = BLOQUEADO → no se muestra en nutriapp.
 */
