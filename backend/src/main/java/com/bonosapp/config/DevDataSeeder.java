 ...
 * Un único nutricionista de demo (linkea por email al usuario nutri@bonosapp.dev del realm)
...
public class DevDataSeeder implements ApplicationRunner {
    ...
    private static final String DEMO_EMAIL = "nutri@bonosapp.dev";
    private static final String ADMIN_EMAIL = "admin@bonosapp.dev";
