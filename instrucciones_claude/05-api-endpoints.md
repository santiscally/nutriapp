...
| POST | `/admin/tiendanube/reconciliar?horas=720` | **S-06** — barre las órdenes pagadas de esa ventana y aplica los bonos que quedaron colgados en PENDIENTE. Para cuando alguien reporta "compré y sigue pendiente": el polling automático sólo mira 24 h atrás, así que un webhook perdido deja el bono sin aplicar para siempre. Default 30 días, tope 90. Idempotente → `{ "horas":720, "desde":ts, "ordenesRevisadas":n, "bonosAplicados":n, "codigos":["RX-…"], "mensaje":"…" }` |
